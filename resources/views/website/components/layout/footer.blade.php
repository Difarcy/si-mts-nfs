            ...
            <div>
                <div class="flex items-center gap-3 mb-4">
                    <a href="/" class="flex items-center gap-3 hover:opacity-90 transition-opacity">
                        <img src="{{ $websiteLogo }}"
                            alt="Logo {{ $namaSekolah }}" class="h-10 w-10 sm:h-12 sm:w-12 object-contain shrink-0">
                ...
                <div class="flex items-center gap-4">
                    ...
                    @if(!empty($socialLinks['instagram']))
                        <a href="{{ $socialLinks['instagram'] }}" target="_blank" rel="noopener noreferrer" class="text-white transition-colors duration-300 hover:text-[#E1306C] transform hover:scale-110" aria-label="Instagram">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 sm:h-6 sm:w-6" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    @if(!empty($socialLinks['x']))
                        <a href="{{ $socialLinks['x'] }}" target="_blank" rel="noopener noreferrer" class="text-white transition-colors duration-300 hover:text-black transform hover:scale-110" aria-label="X (Twitter)">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 sm:h-6 sm:w-6" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    @if(!empty($socialLinks['youtube']))
                        <a href="{{ $socialLinks['youtube'] }}" target="_blank" rel="noopener noreferrer" class="text-white transition-colors duration-300 hover:text-[#FF0000] transform hover:scale-110" aria-label="YouTube">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 sm:h-6 sm:w-6" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    @if(!empty($socialLinks['tiktok']))
                        <a href="{{ $socialLinks['tiktok'] }}" target="_blank" rel="noopener noreferrer" class="text-white transition-colors duration-300 hover:text-black transform hover:scale-110" aria-label="TikTok">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 sm:h-6 sm:w-6" fill="currentColor" viewBox="0 0 24 24">
