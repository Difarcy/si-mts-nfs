            ...
            <div class="flex flex-col lg:flex-row gap-12">
                ...
                <div class="flex flex-row gap-8 sm:gap-12 shrink-0">
                    ...
                    <div class="flex flex-col gap-3 w-14 pt-0 mt-1 pl-1">
                        ...
                        @else
                                <span
                                    class="w-10 h-10 sm:w-12 sm:h-12 bg-white border border-gray-100 flex items-center justify-center transition-all duration-300 rounded-lg shadow-sm cursor-default">
                            @endif
                        ...
                        <form id="contact-form" class="space-y-4" action="{{ route('web.contact.store') }}" method="POST">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <x-website.components.form.input type="email" name="email" label="Email"
                                    placeholder="Masukan Email" required pattern="[^@\s]+@[^@\s]+\.[^@\s]+"
                                    title="Harap sertakan '@' dalam alamat email" maxlength="30" />
                                <x-website.components.form.input type="tel" name="phone" label="Telepon/WA"
                                    placeholder="Masukan Telepon" required pattern="[0-9]{10,15}"
                                    title="Nomor telepon harus berupa angka, minimal 10 dan maksimal 15 digit"
                ...
                <div class="mt-8">
                    <div class="w-full aspect-video md:aspect-[21/9] flex items-center justify-center text-center">
                        @if($kontak?->koordinat)
                            ...
                            @endphp
                            <iframe class="w-full h-full" src="{{ $coordUrl }}" loading="lazy"
