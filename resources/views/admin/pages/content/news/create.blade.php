...
{{-- 
    ...
    - Penjadwalan publikasi (AlpineJS)
    - Validasi client-side (ChangeDetection & SubmitProtection)
--}}
...
@section('content')
    <div class="flex flex-col gap-3" data-page="news-create">
        {{-- Header --}}
        <x-admin.ui.page-header title="Tambah Berita" subtitle="Buat dan publikasikan berita terbaru untuk sekolah">
            <x-slot:actions>
                <div class="flex items-center gap-3">
                    ...
                    <x-admin.form.button type="submit" variant="add" form="news-form"
        ...
        {{-- Form Area --}}
        <x-admin.ui.card>
            <form id="news-form" action="{{ route('admin.konten.berita.store') }}" method="POST" data-submit-confirm="Simpan berita ini?"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                        ...
                        <div class="md:col-span-3 space-y-4">
                            ...
                            <x-admin.form.textarea name="content" label="Deskripsi"
                                placeholder="Tuliskan detail berita di sini..." rows="15" required />
                        </div>
                        ...
                        <div class="md:col-span-1 space-y-4">
                            ...
                            <div class="pt-2 border-t border-gray-100" data-hide-on-draft="true">
                                <x-admin.form.checkbox name="is_highlight" label="Jadikan Highlight" />
                            </div>
