...
@section('content')
    <div class="flex flex-col gap-3 pb-4">
        ...
        <x-admin.ui.page-header title="Hero" subtitle="Kelola konten hero section di halaman utama website">
            <x-slot:actions>
                <x-admin.form.button type="submit" variant="primary" form="hero-form" class="cursor-not-allowed opacity-50" disabled>
                    <x-slot:icon>
        ...
        <x-admin.ui.card bodyClass="p-4 sm:p-6">
            <form id="hero-form" method="POST" action="{{ route('admin.pengaturan.hero.update') }}" class="space-y-6" data-no-submit-protection>
                @csrf
                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <x-admin.form.input name="tagline" label="Tagline" :value="$hero->tagline" placeholder="Masukan Tagline" />
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <x-admin.form.input name="button_url" label="Link Tombol" :value="$hero->button_url" placeholder="Masukan Link Tombol" />
                    </div>
                </div>
            </form>
        </x-admin.ui.card>
