                    ...
                    <tr class="hover:bg-gray-50/50 transition-colors" data-admin-item="table" data-id="{{ $item->id }}"
                        ...
                        <td class="px-2 sm:px-4 py-2 sm:py-3 text-center">
                            <div class="flex flex-col items-center gap-1 sm:gap-1.5">
                                ...
                                @if($item->is_highlight)
                                    <x-admin.ui.badge variant="highlight"
                                        class="scale-75 sm:scale-100 origin-center !text-[10px] sm:!text-[11px]">
                                        Highlight
                                    </x-admin.ui.badge>
                                @endif
                            </div>
                        ...
                        <td class="px-2 sm:px-4 py-2 sm:py-3">
                            <div class="flex items-center justify-center gap-1 sm:gap-2">
                                ...
                                @else
                                    <x-admin.form.button variant="edit" href="{{ route('admin.konten.berita.edit', $item->id) }}"
                                ...
                                <x-admin.form.button variant="delete" class="!p-1.5 sm:!p-2" title="Hapus" data-news-delete
                                    data-news-id="{{ $item->id }}" data-news-title="{{ $item->judul }}">
                                    <x-slot:icon>
                                        <svg class="w-3.5 h-3.5 sm:w-4 sm:h-4" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="bg-white border border-gray-200 rounded-lg overflow-hidden hover:shadow-md transition-all group relative flex flex-col h-full"
                    ...
                    <div class="p-5 flex flex-col flex-grow min-h-[180px]">
                        <div class="mb-3 flex flex-wrap gap-1.5">
                            ...
                            @if($item->is_highlight)
                                <x-admin.ui.badge variant="highlight" class="!px-2 !py-0.5 text-[9px] font-bold">
                                    Highlight
                                </x-admin.ui.badge>
                            @endif
                        </div>
