<header class="bg-green-600 shadow-md">
    <div class="container mx-auto px-4 py-3 md:py-4 flex justify-between items-center">
        ...
        <a href="/" class="flex items-center space-x-2 md:space-x-4">
            <img src="<?php echo e($websiteLogo); ?>" alt="Logo MTs Nurul Falaah Soreang"
        ...
        <div class="flex items-center">
            <?php echo $__env->make('website.components.layout.navbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
    </div>
</header><?php /**PATH C:\laragon\www\si-mts-nfs\resources\views/website/components/layout/header.blade.php ENDPATH**/ ?>