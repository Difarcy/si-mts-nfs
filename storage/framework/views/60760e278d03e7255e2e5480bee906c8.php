    ...
    <div>
        <div class="mb-3">
            <?php if($foto): ?>
                <div class="w-full aspect-3/4 bg-gray-200 overflow-hidden flex items-center justify-center mx-auto max-h-112">
                    <img src="<?php echo e(asset('storage/' . $foto)); ?>" alt="Kepala Madrasah" class="w-full h-full object-cover">
                </div>
            <?php else: ?>
        ...
        <div class="mb-3 text-center">
            <p class="text-xs sm:text-base text-black font-bold text-center font-roboto-slab">
                <?php echo e($nama ?: 'Kepala Madrasah'); ?>
        ...
        <div class="mb-0">
            <div
                ...
                <?php if($sambutan): ?>
                    <p><?php echo e(\Illuminate\Support\Str::limit(trim(strip_tags($sambutan)), 180)); ?></p>
                <?php else: ?>
...
<?php /**PATH C:\laragon\www\si-mts-nfs\resources\views/website/components/content/headmaster-greeting.blade.php ENDPATH**/ ?>