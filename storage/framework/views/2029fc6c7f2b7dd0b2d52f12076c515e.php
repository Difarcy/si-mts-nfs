                ...
                <ul class="space-y-3">
                    <li class="flex items-start gap-2">
                        ...
                        <?php if($kontak?->whatsapp): ?>
                            ...
                            ?>
                            <a href="https://wa.me/<?php echo e($waNumber); ?>" target="_blank" rel="noopener noreferrer" class="inline-block text-xs sm:text-sm md:text-base text-gray-200 hover:text-white transition-colors">
                    ...
                    <li class="flex items-start gap-2">
                        ...
                        <?php if($kontak?->telepon): ?>
                            <a href="tel:<?php echo e(preg_replace('/[^0-9+]/', '', $kontak->telepon)); ?>" class="inline-block text-xs sm:text-sm md:text-base text-gray-200 hover:text-white transition-colors">
                    ...
                    <li class="flex items-start gap-2">
                        ...
                        <?php if($kontak?->email): ?>
                            <a href="mailto:<?php echo e($kontak->email); ?>" class="inline-block text-xs sm:text-sm md:text-base text-gray-200 hover:text-white transition-colors">
