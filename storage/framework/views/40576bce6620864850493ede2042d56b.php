<div class="overflow-x-auto border border-black rounded-lg">
    <table <?php echo e($attributes->merge(['class' => 'w-full text-sm text-left border-collapse'])); ?>>
...
<?php /**PATH C:\laragon\www\si-mts-nfs\resources\views/admin/components/ui/table.blade.php ENDPATH**/ ?>