...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'website.components.layout.page-title','data' => ['title' => 'Pengumuman','tag' => 'h3','margin' => 'mb-4']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Pengumuman','tag' => 'h3','margin' => 'mb-4']); ?>
...
<?php endif; ?>
    ...
    <div class="space-y-4">
        <?php $__empty_1 = true; $__currentLoopData = $infoTerkiniData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="pb-3 border-b border-gray-100 last:border-0 last:pb-0">
                <a href="<?php echo e(route('web.announcement.detail', $item->id)); ?>" class="block group">
                    <h4
                    ...
                    <p
                        ...
                        <?php echo e(\Illuminate\Support\Str::limit(strip_tags($item->deskripsi), 100, '...')); ?>
...
</div><?php /**PATH C:\laragon\www\si-mts-nfs\resources\views/website/components/content/announcement-widget.blade.php ENDPATH**/ ?>