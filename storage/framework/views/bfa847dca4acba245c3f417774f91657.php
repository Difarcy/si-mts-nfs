...
<?php endif; ?>
    ...
    <?php
        $newsItems = $latestNewsWidget ?? collect();
    ?>
    ...
    <div class="space-y-4">
        <?php $__empty_1 = true; $__currentLoopData = $newsItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            <div class="pb-3 border-b border-gray-100 last:border-0 last:pb-0">
                <a href="<?php echo e(route('web.news.detail', $item->id)); ?>" class="group block">
                    <h4
...
</div><?php /**PATH C:\laragon\www\si-mts-nfs\resources\views/website/components/content/news-widget.blade.php ENDPATH**/ ?>