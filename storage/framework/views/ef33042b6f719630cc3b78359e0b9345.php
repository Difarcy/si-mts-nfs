...
<section
    ...
    <div class="container mx-auto px-6 sm:px-4 relative z-10 text-left sm:text-center">
        ...
        <div
            ...
            Sistem Penerimaan Murid Baru <?php echo e($year); ?>

        </div>
        <h1
            class="text-xl sm:text-5xl lg:text-6xl font-black text-white mb-2 sm:mb-6 tracking-tight leading-tight drop-shadow-md">
            <?php echo e($globalSchoolProfile?->nama_sekolah ?? 'MTs Nurul Falaah Soreang'); ?>

        </h1>
        <p class="text-xs sm:text-xl text-white max-w-2xl sm:mx-auto font-medium leading-relaxed mb-6 sm:mb-0">
            <?php echo e($setting?->hero_slogan ?? 'Wujudkan masa depan gemilang bersama kami. Mari bergabung dalam ekosistem pendidikan terbaik untuk mencetak generasi cerdas, religius, dan berkarakter unggul!'); ?>
...
<?php /**PATH C:\laragon\www\si-mts-nfs\resources\views/website/pages/spmb/sections/hero.blade.php ENDPATH**/ ?>