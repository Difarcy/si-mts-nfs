<div class="flex items-center h-full relative w-full justify-end">
    ...
    <div id="search-container" class="hidden absolute inset-y-0 left-0 right-10 flex items-center z-20">
        <form action="<?php echo e(route('web.search')); ?>" method="GET" class="w-full">
    ...
    <?php echo $__env->make('website.components.layout.sidebar-mobile', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</div>
<?php /**PATH C:\laragon\www\si-mts-nfs\resources\views/website/components/layout/navbar.blade.php ENDPATH**/ ?>