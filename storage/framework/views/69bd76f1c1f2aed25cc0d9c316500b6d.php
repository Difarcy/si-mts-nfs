            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                ...
                <?php $__currentLoopData = $requirements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $req): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="group bg-green-50 p-3.5 md:p-4 rounded-xl shadow-sm flex items-center gap-3 md:gap-4 hover:bg-green-700 transition-all duration-300 scroll-animate"
                        style="animation-delay: <?php echo e(($index % 2) * 0.1); ?>s">
                        <div
                        ...
                        <span
                            class="text-xs md:text-base text-black group-hover:text-white font-medium transition-colors font-inter"><?php echo e($req); ?></span>
                    </div>
...
</section><?php /**PATH C:\laragon\www\si-mts-nfs\resources\views/website/pages/spmb/sections/requirements.blade.php ENDPATH**/ ?>