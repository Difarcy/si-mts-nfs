...
<div class="absolute inset-0 flex items-end pb-6 md:pb-16 z-20 pointer-events-none">
    <div class="px-6 max-w-3xl sm:pl-10 lg:pl-20 pointer-events-auto">
        ...
        <?php if($showTagline && !empty($tagline)): ?>
            <p class="text-[10px] sm:text-base font-bold text-white mb-1 sm:mb-2 drop-shadow-md">
                <?php echo e($tagline); ?>
        ...
        <?php if($showTitle && !empty($title)): ?>
            <h1 class="text-base sm:text-3xl md:text-4xl font-bold text-white mb-1.5 sm:mb-4 drop-shadow-lg leading-tight">
                <?php echo e($title); ?>
