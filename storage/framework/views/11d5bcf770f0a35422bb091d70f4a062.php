<div>
    <?php if(isset($promosiBannerPath) && $promosiBannerPath): ?>
        <div class="bg-gray-100 overflow-hidden hover:shadow-md transition-all duration-300 aspect-1920/600">
            <img src="<?php echo e(asset('storage/' . $promosiBannerPath)); ?>" alt="Banner Promosi"
...
<?php /**PATH C:\laragon\www\si-mts-nfs\resources\views/website/pages/home/sections/promosi-banner.blade.php ENDPATH**/ ?>