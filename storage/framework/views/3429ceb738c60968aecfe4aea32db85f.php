    ...
    <div class="container mx-auto px-4 sm:px-4">
        <div class="flex justify-center">
            <div class="grid grid-cols-3 gap-1.5 md:gap-6 w-full max-w-[420px] md:max-w-6xl">
                ...
                <div
                    class="group bg-white rounded-xl md:rounded-2xl shadow-md border border-gray-100 p-2 md:p-6 flex flex-col md:flex-row items-center justify-center md:justify-start gap-1 md:gap-5 min-h-[80px] md:min-h-0 hover:bg-gradient-to-br <?php if($status == 'open'): ?> hover:from-green-600 hover:to-green-700 <?php elseif($status == 'pending'): ?> hover:from-yellow-500 hover:to-yellow-600 <?php else: ?> hover:from-red-600 hover:to-red-700 <?php endif; ?> hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                    <div
                        class="w-7 h-7 md:w-16 md:h-16 shrink-0 rounded-lg md:rounded-2xl bg-<?php echo e($statusColor); ?>-100 text-<?php echo e($statusColor); ?>-600 group-hover:bg-white group-hover:text-<?php echo e($statusColor); ?>-700 flex items-center justify-center group-hover:scale-105 transition-all duration-300">
                        <?php if($status == 'open'): ?>
                    ...
                    <div class="flex flex-col min-w-0 text-center md:text-left">
                        <p
                            class="text-[8px] md:text-sm font-black <?php echo e($statusLabelColor); ?> uppercase tracking-wider mb-0 md:mb-2 group-hover:text-white transition-colors leading-none truncate">
                            Status</p>
                        <h3
                ...
                <div
                    ...
                    <div class="flex flex-col min-w-0 text-center md:text-left">
                        ...
                        <h3
                            class="text-[11px] md:text-2xl font-extrabold text-gray-800 leading-tight group-hover:text-white transition-all duration-300 truncate">
                            <?php echo e($spmb && $spmb->kuota !== null ? number_format((int) $spmb->kuota, 0, ',', '.') . ' Siswa' : '-'); ?>
                    ...
                    <div class="flex flex-col min-w-0 text-center md:text-left">
                        ...
                        <h3
                            ...
                            <?php
                                $biaya = $spmb?->biaya;
                            ?>
                            <?php if($biaya === null || (int) $biaya === 0): ?>
                                Gratis
                            <?php else: ?>
                                Rp. <?php echo e(number_format((int) $biaya, 0, ',', '.')); ?>
...
<?php /**PATH C:\laragon\www\si-mts-nfs\resources\views/website/pages/spmb/sections/info-cards.blade.php ENDPATH**/ ?>